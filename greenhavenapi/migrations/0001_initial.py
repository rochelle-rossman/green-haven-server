    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.TextField(choices=[('living_room', 'Living Room'), ('bedroom', 'Bedroom'), ('office', 'Office'), ('bathroom', 'Bathroom')], max_length=200)),
                ('style', models.TextField(choices=[('modern', 'Modern'), ('industrial', 'Industrial'), ('bohemian', 'Bohemian'), ('farmhouse', 'Farmhouse'), ('traditional', 'Traditional'), ('midcentury_modern', 'Midcentury Modern')], max_length=200)),
